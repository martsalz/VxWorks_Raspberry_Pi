...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -O3 '
           '-Wall -w',
 'CFLAGSFORSHARED': '-fpic -D__SO_PICABILINUX__  -ftls-model=global-dynamic',
 ...
 'CONFIG_ARGS': "'--build=x86_64-pc-linux-gnu' '--host=aarch64-wrs-vxworks' "
                "'--prefix=/usr' "
                "'CONFIG_SITE=/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/usr/mk/config.site' "
                "'CC=wr-cc' 'CXX=wr-c++' 'LD=wr-ld' 'AR=wr-ar' 'NM=wr-nm' "
                "'OBJCOPY=wr-objcopy' 'OBJDUMP=wr-objdump' 'RANLIB=wr-ranlib' "
                "'READELF=wr-readelf' 'SIZE=wr-size' 'STRIP=wr-strip' "
                "'PKG_CONFIG_LIBDIR=/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/usr/3pp/develop/usr/lib' "
                "'PKG_CONFIG_SYSTEM_LIBRARY_PATH=/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/usr/3pp/develop' "
                "'PKG_CONFIG_SYSROOT_DIR=/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/usr/3pp/develop' "
                "'--enable-shared' '--with-libm=no' '--with-ensurepip=no' "
                "'--with-openssl=/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/usr/h/public' "
                "'OPENSSL_LIBS=-lcrypto -lssl -lnet' 'CFLAGS=-w' "
                "'--with-system-ffi=yes' '--disable-test-suites' "
                "'--disable-bytecode-optimizations' "
                "'build_alias=x86_64-pc-linux-gnu' "
                "'host_alias=aarch64-wrs-vxworks'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.8',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/3pp/PYTHON/Python-3.8.0/coverage.info',
 'COVERAGE_REPORT': '/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/3pp/PYTHON/Python-3.8.0/lcov-report',
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-38-vxworks.so',
 'FILEMODE': 644,
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'aarch64-wrs-vxworks',
 'INCLDIRSTOMAKE': '/usr/include /usr/include /usr/include/python3.8 '
                   '/usr/include/python3.8',
 'INCLUDEDIR': '/usr/include',
 'INCLUDEPY': '/usr/include/python3.8',
 'INSTALL': '/home/dan/vx7/vxworks_2103/vxworks/21.03/host/x86_64-linux/bin/install '
            '-c',
 'INSTALL_DATA': '/home/dan/vx7/vxworks_2103/vxworks/21.03/host/x86_64-linux/bin/install '
                 '-c -m 644',
 'INSTALL_OPT_PYC': 'no',
 'INSTALL_PROGRAM': '/home/dan/vx7/vxworks_2103/vxworks/21.03/host/x86_64-linux/bin/install '
                    '-c',
 'INSTALL_SCRIPT': '/home/dan/vx7/vxworks_2103/vxworks/21.03/host/x86_64-linux/bin/install '
                   '-c',
 'INSTALL_SHARED': '/home/dan/vx7/vxworks_2103/vxworks/21.03/host/x86_64-linux/bin/install '
                   '-c -m 755',
 'INSTALL_TEST_SUITES': 'no',
 'INSTSONAME': 'libpython3.8.so.1.0',
 'IO_H': 'Modules/_io/_iomodule.h',
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'wr-c++ -shared',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 ...
 'LIBPL': '/usr/lib/python3.8/config-3.8-vxworks',
 'LIBPYTHON': '',
 ...
 'MKDIR_P': '/home/dan/vx7/vxworks_2103/vxworks/21.03/host/x86_64-linux/bin/mkdir '
            '-p',
 ...
 'MODULE_OBJS': '\\',
 'MULTIARCH': 'vxworks',
 'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"vxworks\\"',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/3pp/PYTHON/Python-3.8.0 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/3pp/PYTHON/Python-3.8.0/`cat '
                     'pybuilddir.txt`:)./Lib '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             '-Wunreachable-code -DNDEBUG -O3 -Wall -w '
                             ...
                             '-D__SO_PICABILINUX__  -ftls-model=global-dynamic '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   '-DNDEBUG -O3 -Wall -w -std=c99 -Wextra -Wno-unused-result '
                   '-Wno-unused-parameter -Wno-missing-field-initializers '
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                        '-DNDEBUG -O3 -Wall -w -std=c99 -Wextra '
 ...
 'READELF': 'wr-readelf',
 'REGR_TEST_SKELETON': '__init__.py __main__.py regrtest.py test_support.py',
 ...
 'abs_builddir': '/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/3pp/PYTHON/Python-3.8.0',
 'abs_srcdir': '/home/dan/workspaces/ksdk_build/raspberrypi4b/rpi4Vsb/3pp/PYTHON/Python-3.8.0',
